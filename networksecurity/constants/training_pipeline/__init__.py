...
MODEL_TRAINER_REPORT_DIR: str = "model_report"
MODEL_TRAINER_MODEL_COMPARISON_FILE_NAME: str = "model_comparison.csv"
MODEL_TRAINER_MODEL_COMPARISON_JSON_FILE_NAME: str = "model_comparison.json"
